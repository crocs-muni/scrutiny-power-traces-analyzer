...
public class HightlightingChartMouseListener implements ChartMouseListener {
    ...
    public void chartMouseClicked(ChartMouseEvent cme) {
        ...
        if (extractionTabModel.getFirstIndexOnChartTrace() == null || extractionTabModel.getFirstIndexOnChartTrace() == 0) {
            ...
            firstTimeJSpinner.setValue(extractionTabModel.getCurrentTrace().getTimeOnPosition(ChartHelper.modifiedToOriginalIndex(extractionTabModel.getFirstIndexOnChartTrace())));
        } else {
            ...
            firstTimeJSpinner.setValue(extractionTabModel.getCurrentTrace().getTimeOnPosition(ChartHelper.modifiedToOriginalIndex(extractionTabModel.getFirstIndexOnChartTrace())));
            lastTimeJSpinner.setValue(extractionTabModel.getCurrentTrace().getTimeOnPosition(ChartHelper.modifiedToOriginalIndex(extractionTabModel.getLastIndexOnChartTrace())));
        }
    }
